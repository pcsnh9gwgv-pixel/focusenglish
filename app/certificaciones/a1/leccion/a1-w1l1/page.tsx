...
const alphabetData = [
  ...
  { letter: 'N', name: 'en', ipa: '/ɛn/', example: 'Nose', exampleEs: 'Nariz', category: 'consonant' },
  { letter: 'O', name: 'ou', ipa: '/oʊ/', example: 'Orange', exampleEs: 'Naranja', category: 'vowel' },
  { letter: 'P', name: 'pi', ipa: '/piː/', example: 'Pen', exampleEs: 'Bolígrafo', category: 'consonant' },
  { letter: 'Q', name: 'kiu', ipa: '/kjuː/', example: 'Queen', exampleEs: 'Reina', category: 'consonant' },
  { letter: 'R', name: 'ar', ipa: '/ɑːr/', example: 'Red', exampleEs: 'Rojo', category: 'consonant' },
  { letter: 'S', name: 'es', ipa: '/ɛs/', example: 'Sun', exampleEs: 'Sol', category: 'consonant' },
  { letter: 'T', name: 'ti', ipa: '/tiː/', example: 'Tree', exampleEs: 'Árbol', category: 'consonant' },
  { letter: 'U', name: 'iu', ipa: '/juː/', example: 'Up', exampleEs: 'Arriba', category: 'vowel' },
  { letter: 'V', name: 'vi', ipa: '/viː/', example: 'Van', exampleEs: 'Furgoneta', category: 'consonant' },
  { letter: 'W', name: 'dabel iu', ipa: '/ˈdʌbəl juː/', example: 'Water', exampleEs: 'Agua', category: 'consonant' },
  { letter: 'X', name: 'eks', ipa: '/ɛks/', example: 'Box', exampleEs: 'Caja', category: 'consonant' },
  { letter: 'Y', name: 'uai', ipa: '/waɪ/', example: 'Yellow', exampleEs: 'Amarillo', category: 'consonant' },
  { letter: 'Z', name: 'zi', ipa: '/ziː/', example: 'Zebra', exampleEs: 'Cebra', category: 'consonant' }
]
