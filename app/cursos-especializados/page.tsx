        ...
        <section className="py-20 px-4 sm:px-6 lg:px-8">
          <div className="max-w-7xl mx-auto">
            <div className="text-center mb-16">
              ...
              <p className="text-lg text-slate-600 max-w-2xl mx-auto">
                Estudiantes que mejoraron su carrera con nuestros cursos especializados
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              <div className="bg-white rounded-2xl shadow-lg border border-slate-200 p-6">
                <div className="flex items-center gap-3 mb-4">
                  ...
                  <div>
                    <div className="font-bold text-slate-900">María C.</div>
                    <div className="text-sm text-slate-600">Marketing Manager</div>
                  </div>
                </div>
                <p className="text-slate-700 mb-4">
                  "Después del curso de Marketing, conseguí un puesto en una startup de Barcelona. El vocabulario técnico y las presentaciones en inglés fueron clave en mi entrevista."
                </p>
              ...
              <div className="bg-white rounded-2xl shadow-lg border border-slate-200 p-6">
                <div className="flex items-center gap-3 mb-4">
                  ...
                  <div>
                    <div className="font-bold text-slate-900">Jorge R.</div>
                    <div className="text-sm text-slate-600">Software Engineer</div>
                  </div>
                </div>
                <p className="text-slate-700 mb-4">
                  "Me mudé a Dublín hace 6 meses. El curso de Tech & IT me preparó perfectamente para las entrevistas técnicas en inglés. Ahora trabajo en Google."
                </p>
              ...
              <div className="bg-white rounded-2xl shadow-lg border border-slate-200 p-6">
                <div className="flex items-center gap-3 mb-4">
                  <div className="w-12 h-12 rounded-full bg-gradient-to-br from-emerald-600 to-green-600 flex items-center justify-center text-white font-bold">
                    LP
                  </div>
                  <div>
                    <div className="font-bold text-slate-900">Laura P.</div>
                    <div className="text-sm text-slate-600">Fund Administrator</div>
                  </div>
                </div>
                <p className="text-slate-700 mb-4">
                  "El curso para Luxemburgo fue increíblemente específico. Aprendí toda la terminología de fondos que necesitaba. En 3 meses tenía oferta de trabajo."
                </p>
